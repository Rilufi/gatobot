...
queries = "#CatsOfTwitter -filter:retweets filter:media AND #DogsOfTwitter -filter:retweets filter:media"
for tweet in tweepy.Cursor(api.search, q=queries).items(2):
